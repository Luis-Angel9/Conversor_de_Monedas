 ...
 * @author HP
 */
public class inicio_panel extends javax.swing.JFrame {
    private ImageIcon imagen;
    private Icon icono;

    public inicio_panel() {
        initComponents();
        this.imagenes(fondo,"src/Conversor_imagenes/alura.jpg");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(inicio_panel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
